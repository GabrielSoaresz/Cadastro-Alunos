...
<label>Nome</label>
<input type="text"
name="name" value="<?=$student['name'];?>" class="form-control">
</div>
...
name="email" value="<?=$student['email'];?>" class="form-
control">
...
name="phone" value="<?=$student['phone'];?>" class="form-
control">
...
name="course" value="<?=$student['course'];?>" class="form-
control">
...
<button type="submit"
name="update_student" class="btn btn-primary">
